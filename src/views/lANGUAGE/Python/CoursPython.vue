      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-2">
          ...
          <div class="flex items-center space-x-3">
            <div class="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-500 to-yellow-500 backdrop-blur-sm rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg border border-emerald-400/30 group hover:shadow-emerald-400/20 hover:scale-105 transition-all">
  <span class="text-white font-bold text-sm sm:text-base font-mono tracking-tighter">Py</span>
</div>
            <div>

<template>
  <div class="min-h-screen bg-gradient-to-b from-blue-50 to-gray-50 dark:from-gray-900 dark:to-gray-950 transition-colors duration-300">
    <!-- Header responsive -->
      ...
      <div class="flex flex-col lg:flex-row gap-6">
          ...
          >
            ...
            <div class="p-4">
              ...
              <div class="flex items-center justify-between mb-6">
                <div>
                  <h2 class="text-lg font-bold text-gray-800 dark:text-white">Menu Java</h2>
        ...
        <aside class="hidden lg:block lg:w-1/3 xl:w-1/4">
          <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden sticky top-6">
            ...
            <div class="bg-gradient-to-r from-red-600 to-red-700 p-4">
              ...
              <p class="text-red-100 dark:text-red-200 text-sm">{{ currentLevel.name }} • {{ getLevelProgress(selectedLevel) }}% complété</p>
            </div>
        ...
        <main class="flex-1">
          <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
            <!-- Header du contenu -->
            <div class="bg-gradient-to-r from-red-50 to-red-100 dark:from-gray-800 dark:to-gray-900 p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700">
              <div class="space-y-4">
                <!-- Breadcrumb -->
